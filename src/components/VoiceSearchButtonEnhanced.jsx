...
const VoiceSearchButtonEnhanced = ({ onTranscription, placeholder = "Recording...", defaultLanguage = "auto" }) => {
    const [isRecording, setIsRecording] = useState(false);
    const [isProcessing, setIsProcessing] = useState(false);
    const [language, setLanguage] = useState(defaultLanguage); // 'auto', 'ar', 'en'
    ...
    const transcribeAudio = async (audioBlob) => {
        ...
        try {
            ...
            console.log('Sending audio for transcription:', audioBlob.size, 'bytes', 'language:', language);

            // Send to our API endpoint
            const API_URL = process.env.REACT_APP_API_URL || 'https://qurancompare.onrender.com';
            const response = await fetch(`${API_URL}/transcribe-audio${language !== 'auto' ? `?language=${language}` : ''}`, {
                method: 'POST',
                body: formData
            });
                ...
                <div style={{
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            padding: '10px 15px',
                            background: language === 'auto' ? '#e2e8f0' : 'transparent',
                            border: 'none',
                            cursor: 'pointer',
                            textAlign: 'left',
                            display: 'flex',
                        ...
                        onMouseLeave={(e) => e.currentTarget.style.background = language === 'auto' ? '#e2e8f0' : 'transparent'}
                    >
                        <span>🌍</span>
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            padding: '10px 15px',
                            background: language === 'ar' ? '#e2e8f0' : 'transparent',
                            border: 'none',
                            cursor: 'pointer',
                            textAlign: 'left',
                            display: 'flex',
                        ...
                        onMouseEnter={(e) => e.currentTarget.style.background = '#f3f4f6'}
                        onMouseLeave={(e) => e.currentTarget.style.background = language === 'ar' ? '#e2e8f0' : 'transparent'}
                    >
                        <span>🇸🇦</span>
                    ...
                    <button
                        ...
                        style={{
                            width: '100%',
                            padding: '10px 15px',
                            background: language === 'en' ? '#e2e8f0' : 'transparent',
                            border: 'none',
                            cursor: 'pointer',
                            textAlign: 'left',
                            display: 'flex',
                        ...
                        onMouseEnter={(e) => e.currentTarget.style.background = '#f3f4f6'}
                        onMouseLeave={(e) => e.currentTarget.style.background = language === 'en' ? '#e2e8f0' : 'transparent'}
                    >
                        <span>🇺🇸</span>
                        <span>English</span>
                    </button>
...
export default VoiceSearchButtonEnhanced;